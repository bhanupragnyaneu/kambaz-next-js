...
export default function ModulesControls() {
 return (
   <div id="wd-modules-controls" className="text-nowrap">
     ...
     <Button variant="secondary" size="lg" className="float-end me-3" id="wd-collapse-all">
      Collapse All
    </Button>
    <Button variant="secondary" size="lg" className="float-end me-3" id="wd-view-progress">
      View Progress
    </Button>
