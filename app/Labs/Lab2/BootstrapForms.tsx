...
<div id="wd-css-responsive-forms-2">
   ...
   <Form>
      <Row className="mb-3" id="formHorizontalEmail">
         <FormLabel column sm={2}> Email </FormLabel>
         <Col sm={10}> <FormControl type="email" placeholder="name@example.com" /> </Col>
      </Row>
      <Row className="mb-3" id="formHorizontalPassword">
         <FormLabel column sm={2}> Password </FormLabel>
