    ...
    <div id="wd-lab1">
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                <li>Get maggi instant noodles from the store</li>
                <li>Boil water</li>
                <li>Add noodles and cook for 2 minutes</li>
                <li>Drain water and serve</li>
            </ol>
        ...
        <div id="wd-images">
            ...
            <img id="wd-starship" width="400px" alt="teslabot online image"  src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" />
            <br />
